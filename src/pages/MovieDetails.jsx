...
const MovieDetails = () => {
  ...
  if (loading) {
    return (
      <div className='w-full h-[70vh] min-h-[480px] bg-black animate-pulse' />
    )
  }
            ...
            <div className='flex flex-wrap items-center gap-5 pt-3'>
              {details.imdb_id && (
                <a
                  ...
                  className='flex items-center h-10 gap-2 bg-amber-500 hover:bg-amber-400 text-black font-bold p-2.5 rounded-lg transition-all shadow-md shadow-amber-500/20'
                >
              ...
              {details.homepage && (
                <a
                  ...
                  className='flex items-center h-10 gap-2 bg-zinc-900 hover:bg-zinc-800 text-white font-medium p-3 rounded-lg border border-zinc-800 transition-all'
                >
                  <span>Watch Now</span>
                </a>
              )}
